...
cap = cv.VideoCapture("path_to_video / camera")
...
while cap.isOpened():
    ...
    start_point = (350, 420)  # Punkt początkowy strzałki (tuż pod tekstem)
    end_point = (350, 460)    # Punkt końcowy strzałki (niżej w pionie)
    cv.arrowedLine(frame, start_point, end_point, (255, 0, 0), 2, tipLength=0.3)  # Strzałka w dół z czerwonym kolorem
